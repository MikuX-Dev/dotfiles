...
complete -c mbimcli -l help-google -d 'Show Google Service options . SS "Basic Connect options:"'
...
complete -c mbimcli -l google-query-carrier-lock -d 'Query Google Carrier Lock . SS "Application Options:"'
