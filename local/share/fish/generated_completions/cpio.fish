...
complete -c cpio -s W -l warning -d 'Controls what warnings are displayed'
...
complete -c cpio -l ignore-dirnlink -d 'Store 2 in the  nlink field of each directory archive member, instead of the …'
